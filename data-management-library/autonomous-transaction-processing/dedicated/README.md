i<table class="tbl-heading"><tr><td class="td-logo">[![](images/obe_tag.png)](README.md)
...
**[Click here to run Lab 10](LabGuide1000UsingSQLDevWebConsole.md)**
...
**[Click here to run Lab 11](LabGuide1100BuidingApexAppsOnDedicatedAutonomousDB.md)**
## Lab 12: Managing performance using the autonomous performance hub

**Key Objectives**:

As an application developer, DBA or DevOps user,

- Access sqldevweb console
- Invoke performance hub
- Understand features and capabilities of performance hub

**[Click here to run Lab 12](LabGuide1200PerformanceHub.md)**
