...
###### Many thanks to author for his kind use: Ruggero Citton (<ruggero.citton@oracle.com>) - Oracle RAC Pack, Cloud Innovation and Solution Engineering Team
...
## Getting started
1. Clone this repository `git clone https://orahub.oci.oraclecorp.com/oracle-linux/vagrant-boxes.git`
